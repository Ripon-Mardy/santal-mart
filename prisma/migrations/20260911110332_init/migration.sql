...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'MOCK_CARD', 'MOCK_WALLET');
...
-- CreateEnum
CREATE TYPE "ReturnReason" AS ENUM ('WRONG_PRODUCT', 'DAMAGED', 'NOT_AS_DESCRIBED', 'MISSING_ITEM', 'OTHER');

-- CreateEnum
CREATE TYPE "ReturnStatus" AS ENUM ('REQUESTED', 'APPROVED', 'REJECTED', 'PICKUP', 'RECEIVED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "RefundStatus" AS ENUM ('PENDING', 'PROCESSED', 'FAILED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER', 'PAYMENT', 'SELLER', 'PRODUCT', 'REVIEW', 'PAYOUT', 'SYSTEM');

-- CreateEnum
CREATE TYPE "AddressType" AS ENUM ('HOME', 'OFFICE', 'OTHER');

-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'CANCELLATION', 'RESERVATION', 'RELEASE');

-- CreateEnum
CREATE TYPE "BannerType" AS ENUM ('HERO', 'PROMOTIONAL', 'CATEGORY');
...
CREATE TABLE "SellerOrder" (
    ...
    "payoutTotal" DECIMAL(12,2) NOT NULL DEFAULT 0,
    "trackingNumber" TEXT,
...
CREATE TABLE "OrderItem" (
    ...
    "sellerEarning" DECIMAL(12,2) NOT NULL,
...
CREATE TABLE "Payout" (
    ...
    "method" TEXT NOT NULL DEFAULT 'MOCK_BANK_TRANSFER',
...
-- CreateIndex
CREATE INDEX "Product_isPublished_status_idx" ON "Product"("isPublished", "status");
...
-- CreateIndex
CREATE UNIQUE INDEX "SellerOrder_subOrderNumber_key" ON "SellerOrder"("subOrderNumber");
...
-- CreateIndex
CREATE INDEX "OrderStatusEvent_sellerOrderId_idx" ON "OrderStatusEvent"("sellerOrderId");
...
-- CreateIndex
CREATE INDEX "Commission_scope_idx" ON "Commission"("scope");
...
-- CreateIndex
CREATE INDEX "ShippingZone_sellerId_idx" ON "ShippingZone"("sellerId");
...
-- AddForeignKey
ALTER TABLE "WalletTransaction" ADD CONSTRAINT "WalletTransaction_sellerOrderId_fkey" FOREIGN KEY ("sellerOrderId") REFERENCES "SellerOrder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ShippingZone" ADD CONSTRAINT "ShippingZone_sellerId_fkey" FOREIGN KEY ("sellerId") REFERENCES "Seller"("id") ON DELETE CASCADE ON UPDATE CASCADE;
